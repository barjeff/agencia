...
const playa = ( new servicio ("./img/rio.jpg", "Rio de Janeiro", "Conocé un paraiso viajando a rio", "a consultar", "9","destino" ));
...
actividadesyexperiencia.addEventListener("click", function (e) {
    ...
    divoptions.classList.remove( "d-none");
...
btnDestinos.addEventListener("click", function (e) {
    ...
    carouselExampleCaptions.style.display = 'none';
     /// OCULTO DIV PRECIOS
     const animationdiv = document.getElementById("divoptions")
